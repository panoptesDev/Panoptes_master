...
then about 1,000 lines of changes is about the most you should ask a Panoptes
...
is ready to be integrated, the Panoptes maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the Panoptes
...
Panoptes's architecture is described by docs generated from markdown files in
...
[Accepted Design Proposals](https://docs.panoptes.com/proposals/accepted-design-proposals)
section of the Panoptes docs.  Here's the full process:
