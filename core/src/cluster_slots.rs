...
use panoptes_runtime::{bank_forks::BankForks, epoch_stakes::NodeIdToVoteAccounts};
...
mod tests {
    use super::*;
    use panoptes_runtime::epoch_stakes::NodeVoteAccounts;
    ...
    fn test_best_peer_2() {
        ...
        let k1 = panoptes_sdk::pubkey::new_rand();
        let k2 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.id = panoptes_sdk::pubkey::new_rand();
        }
        let slot = 9;
