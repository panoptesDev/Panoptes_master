...
pub struct Validator {
    ...
    tpu: Tpu,
    tvu: Tvu,
    ip_echo_server: Option<panoptes_net_utils::IpEchoServer>,
}
...
impl Validator {
    pub fn new(
        ...
        if panoptes_perf::perf_libs::api().is_some() {
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        let ip_echo_server = match node.sockets.ip_echo {
            None => None,
            Some(tcp_listener) => Some(panoptes_net_utils::ip_echo_server(
                tcp_listener,
...
fn new_banks_from_ledger(
    ...
    *start_progress.write().unwrap() = ValidatorStartProgress::LoadingLedger;
    ...
    if let Some(warp_slot) = config.warp_slot {
        ...
        let archive_file = panoptes_runtime::snapshot_utils::bank_to_snapshot_archive(
            ledger_path,
            &bank_forks.root_bank(),
            None,
...
fn report_target_features() {
    ...
    //
    // It's going to require more more work to get Panoptes building
...
mod tests {
    use super::*;
    use panoptes_ledger::{create_new_tmp_ledger, genesis_utils::create_genesis_config_with_leader};
    use panoptes_sdk::genesis_config::create_genesis_config;
    use panoptes_sdk::poh_config::PohConfig;
    ...
    fn test_backup_and_clear_blockstore() {
        ...
        panoptes_logger::setup();
        use panoptes_ledger::get_tmp_ledger_path;
        use panoptes_ledger::{blockstore, entry};
    ...
    fn test_poh_speed() {
        ...
        let poh_config = PohConfig {
            target_tick_duration: Duration::from_millis(panoptes_sdk::clock::MS_PER_TICK),
            // make PoH rate really fast to cause the panic condition
            hashes_per_tick: Some(100 * panoptes_sdk::clock::DEFAULT_HASHES_PER_TICK),
            ..PohConfig::default()
        };
