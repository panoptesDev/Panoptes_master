...
use panoptes_ledger::blockstore_processor::{ConfirmationProgress, ConfirmationTiming};
use panoptes_runtime::{bank::Bank, bank_forks::BankForks, vote_account::ArcVoteAccount};
...
mod test {
    ...
    fn test_add_vote_pubkey() {
        ...
        let mut vote_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        vote_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(panoptes_sdk::pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = panoptes_sdk::pubkey::new_rand();
