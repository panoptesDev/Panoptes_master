use panoptes_client::{pubsub_client::PubsubClient, rpc_client::RpcClient, rpc_response::SlotInfo};
...
fn test_rpc_client() {
    ...
    assert_eq!(
        client.get_version().unwrap().panoptes_core,
        panoptes_version::semver!()
    );
