...
// Allows macro expansion of `use ::panoptes_program::*` to work within this crate
extern crate self as panoptes_program;
...
/// use std::str::FromStr;
/// use panoptes_program::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use panoptes_program::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use panoptes_sdk_macro::program_declare_id as declare_id;
...
/// ```compile_fail
/// # use panoptes_program::unchecked_div_by_const;
/// # fn main() {
