#pragma once
/**
 * @brief Panoptes C-based BPF program utility functions and types
 */
 ...
 */
#define PANO_ARRAY_SIZE(a) (sizeof(a) / sizeof(a[0]))
...
/**
 * The Panoptes runtime provides a memory region that is available to programs at
 * a fixed virtual address and length. The builtin functions `sol_calloc` and
 * `sol_free` call into the Panoptes runtime to allocate from this memory region
