...
use panoptes_program::{account_info::AccountInfo, sysvar::Sysvar};
...
pub fn create_account_with_fields<S: Sysvar>(
    ...
    let mut account = Account::new(lamports, data_len, &panoptes_program::sysvar::id());
...
impl panoptes_program::account_info::Account for Account {
