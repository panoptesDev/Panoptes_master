...
import {
  ...
  ParsedInstruction,
  Secp256k1Program,
} from "@panoptes/web3.js";
import { Cluster } from "providers/cluster";
import { SerumMarketRegistry } from "serumMarketRegistry";
import { TokenInfoMap } from "@panoptes/spl-token-registry";
...
export enum PROGRAM_NAMES {
  ...
  BREAK_PANOPTES = "Break Panoptes Program",
...
export const PROGRAM_DEPLOYMENTS = {
  ...
  [PROGRAM_NAMES.BREAK_PANOPTES]: LIVE_CLUSTERS,
...
export const PROGRAM_NAME_BY_ID = {
  ...
  BrEAK7zGZ6dM71zUDACDqJnekihmwF15noTddWTsknjC: PROGRAM_NAMES.BREAK_PANOPTES,
