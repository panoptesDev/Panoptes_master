...
- Price ratio
  -  An expression of the relative prices of two tokens. Calculated with the Base
     ...
     [exchange_state.rs](https://github.com/panoptes-labs/panoptes/blob/c2fdd1362a029dcf89c8907c562d2079d977df11/programs/exchange_api/src/exchange_state.rs#L7)
- Order request
...
```bash
$ RUST_LOG=panoptes_bench_exchange=info,panoptes=info cargo test --release -- --nocapture test_exchange_local_cluster
```
