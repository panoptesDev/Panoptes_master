...
use panoptes_sdk::signature::{read_keypair_file, Keypair};
...
pub fn extract_args(matches: &ArgMatches) -> Config {
    ...
    args.entrypoint_addr = panoptes_net_utils::parse_host_port(
    ...
    args.faucet_addr = panoptes_net_utils::parse_host_port(matches.value_of("faucet").unwrap())
        .unwrap_or_else(|e| {
