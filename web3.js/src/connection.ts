...
/**
 * Network Inflation
 * (see https://docs.panoptes.com/implemented-proposals/ed_overview)
 */
...
/**
 * Epoch schedule
 * (see https://docs.panoptes.com/terminology#epoch)
 */
...
/**
 * Leader schedule
 * (see https://docs.panoptes.com/terminology#leader-schedule)
 */
 ...
 */
export type Version = {
  /** Version of panoptes-core */
  'panoptes-core': string;
  'feature-set'?: number;
};
...
export class Connection {
  ...
  constructor(
    ...
    // we're directly trying to connect to panoptes-validator's ws listening port.
    ...
    if (response === null) {
      ...
      throw new Error(
        `Transaction was not confirmed in ${duration.toFixed(
          2,
        )} seconds. It is unknown if it succeeded or failed. Check signature ${signature} using the Panoptes Explorer or CLI tools.`,
      );
    }
