...
use panoptes_sdk::{client::SyncClient, genesis_config::create_genesis_config, signature::Signer};
...
fn test_program_native_noop() {
    ...
    bank.add_native_program("panoptes_noop_program", &program_id, false);
