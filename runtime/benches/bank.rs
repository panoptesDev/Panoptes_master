...
use log::*;
use panoptes_runtime::{bank::*, bank_client::BankClient, loader_utils::create_invoke_instruction};
use panoptes_sdk::{
    client::AsyncClient,
    client::SyncClient,
...
fn do_bench_transactions(
    ...
    bank.add_native_program("panoptes_noop_program", &Pubkey::new(&NOOP_PROGRAM_ID), false);
