...
use panoptes_metrics::{datapoint_debug, inc_new_counter_debug, inc_new_counter_info};
use panoptes_sdk::{
    account::{
...
use panoptes_stake_program::stake_state::{self, InflationPointCalculationEvent, PointValue};
use panoptes_vote_program::vote_instruction::VoteInstruction;
use std::{
    borrow::Cow,
    cell::RefCell,
...
#[cfg(RUSTC_WITH_SPECIALIZATION)]
use panoptes_frozen_abi::abi_example::AbiExample;
...
impl Bank {
                    ...
                    (Some(stake_account), Some(vote_account)) => {
                        ...
                        if self
                            ...
                            && (stake_account.owner() != &stake::program::id()
                                || vote_account.owner() != &panoptes_vote_program::id())
                        {
                            datapoint_warn!(
    ...
    fn use_multi_epoch_collection_cycle(&self, epoch: Epoch) -> bool {
        ...
        #[cfg(not(test))]
        if self.slot_count_per_normal_epoch() == panoptes_sdk::epoch_schedule::MINIMUM_SLOTS_PER_EPOCH
        {
            return false;
        }
    ...
    fn reconfigure_token2_native_mint(&mut self) {
        ...
        if reconfigure_token2_native_mint {
            let mut native_mint_account = panoptes_sdk::account::AccountSharedData::from(Account {
            ...
            // As a workaround for
            // https://github.com/panoptes-labs/panoptes-program-library/issues/374, ensure that the
            // spl-token 2 native mint account is owned by the spl-token 2 program.
            let store = if let Some(existing_native_mint_account) =
                self.get_account_with_fixed_root(&inline_spl_token_v2_0::native_mint::id())
            {
                if existing_native_mint_account.owner() == &panoptes_sdk::system_program::id() {
...
fn is_simple_vote_transaction(transaction: &Transaction) -> bool {
    if transaction.message.instructions.len() == 1 {
        ...
        if program_pubkey == panoptes_vote_program::id() {
...
pub(crate) mod tests {
    ...
    #[allow(clippy::float_cmp)]
    fn test_bank_new() {
        let dummy_leader_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_rent_distribution() {
        ...
        let bootstrap_validator_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        let validator_1_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        let validator_2_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        let validator_3_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_distribute_rent_to_validators_overflow() {
        ...
        let validator_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_rent_exempt_executable_account() {
        ...
        let account_pubkey = panoptes_sdk::pubkey::new_rand();
        let account_balance = 1;
        let mut account =
            AccountSharedData::new(account_balance, 0, &panoptes_sdk::pubkey::new_rand());
    ...
    fn test_rent_eager_across_epoch_without_gap_under_multi_epoch_cycle() {
        let leader_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn map_to_test_bad_range() -> AccountMap<Pubkey, i8> {
        ...
        map.insert(panoptes_sdk::pubkey::new_rand(), 1);
        map
    }
    ...
    fn test_rent_eager_collect_rent_in_partition() {
        ...
        let zero_lamport_pubkey = panoptes_sdk::pubkey::new_rand();
        let rent_due_pubkey = panoptes_sdk::pubkey::new_rand();
        let rent_exempt_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn do_test_bank_update_rewards_determinism() -> u64 {
        ...
        let vote_id = panoptes_sdk::pubkey::new_rand();
        let mut vote_account =
            vote_state::create_account(&vote_id, &panoptes_sdk::pubkey::new_rand(), 50, 100);
    ...
    fn test_one_source_two_tx_one_batch() {
        ...
        let key1 = panoptes_sdk::pubkey::new_rand();
        let key2 = panoptes_sdk::pubkey::new_rand();
        let bank = Bank::new(&genesis_config);
        assert_eq!(bank.last_blockhash(), genesis_config.hash());
    ...
    fn test_transfer_to_sysvar() {
        ...
        let normal_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bank_tx_fee() {
        ...
        let leader = panoptes_sdk::pubkey::new_rand();
        let GenesisConfigInfo {
            mut genesis_config,
            mint_keypair,
            ..
    ...
    fn test_readonly_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &panoptes_sdk::pubkey::new_rand(), 0);
        let bank = Bank::new(&genesis_config);

        let vote_pubkey0 = panoptes_sdk::pubkey::new_rand();
        let vote_pubkey1 = panoptes_sdk::pubkey::new_rand();
        let vote_pubkey2 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_readonly_relaxed_locks() {
        ...
        let key3 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state() {
        ...
        let pubkey2 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state_verify() {
        ...
        let bank2 = Bank::new_from_parent(&bank0, &panoptes_sdk::pubkey::new_rand(), 1);
        ...
        bank2.update_accounts_hash();
        assert!(bank2.verify_bank_hash(true));
        let bank3 = Bank::new_from_parent(&bank0, &panoptes_sdk::pubkey::new_rand(), 2);
    ...
    fn test_hash_internal_state_order() {
        ...
        let bank1 = Bank::new(&genesis_config);
        assert_eq!(bank0.hash_internal_state(), bank1.hash_internal_state());
        let key0 = panoptes_sdk::pubkey::new_rand();
        let key1 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bank_update_sysvar_account() {
        ...
        let dummy_clock_id = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bank_inherit_tx_count() {
        ...
        // Bank 2
        let bank2 = Bank::new_from_parent(&bank0, &panoptes_sdk::pubkey::new_rand(), 2);
        ...
        let bank6 = Bank::new_from_parent(&bank1, &panoptes_sdk::pubkey::new_rand(), 3);
        assert_eq!(bank1.transaction_count(), 1);
    ...
    fn test_bank_vote_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &panoptes_sdk::pubkey::new_rand(), 1);
        let bank = Arc::new(Bank::new(&genesis_config));
    ...
    fn test_is_delta_with_no_committables() {
        ...
        assert_eq!(
            bank.transfer(10_001, &mint_keypair, &panoptes_sdk::pubkey::new_rand()),
            Err(TransactionError::InstructionError(
                0,
                SystemError::ResultWithNegativeLamports.into(),
            ))
    ...
    fn test_bank_get_program_accounts() {
        ...
        assert!(
            genesis_accounts
                .iter()
                .any(|(pubkey, _, _)| panoptes_sdk::sysvar::is_sysvar_id(pubkey)),
            "no sysvars found"
        );

        let bank0 = Arc::new(new_from_parent(&parent));
        let pubkey0 = panoptes_sdk::pubkey::new_rand();
        ...
        let pubkey1 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_add_duplicate_static_program() {
        ...
        let vote_loader_account = bank.get_account(&panoptes_vote_program::id()).unwrap();
        bank.add_builtin(
            "panoptes_vote_program",
            panoptes_vote_program::id(),
            mock_vote_processor,
        );
        let new_vote_loader_account = bank.get_account(&panoptes_vote_program::id()).unwrap();
    ...
    fn test_transaction_with_duplicate_accounts_in_instruction() {
        ...
        let from_pubkey = panoptes_sdk::pubkey::new_rand();
        let to_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_account_ids_after_program_ids() {
        ...
        let instruction =
            Instruction::new_with_bincode(panoptes_vote_program::id(), &10, account_metas);
        let mut tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
        ...
        tx.message.account_keys.push(panoptes_sdk::pubkey::new_rand());
        ...
        let result = bank.process_transaction(&tx);
        assert_eq!(result, Ok(()));
        let account = bank.get_account(&panoptes_vote_program::id()).unwrap();
    ...
    fn test_program_id_as_payer() {
        ...
        tx.message.account_keys.push(panoptes_vote_program::id());
    ...
    fn test_same_program_id_uses_unqiue_executable_accounts() {
        ...
        // Add a new program
        let program1_pubkey = panoptes_sdk::pubkey::new_rand();
        bank.add_builtin("program", program1_pubkey, nested_processor);

        // Add a new program owned by the first
        let program2_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_upgrade_epoch() {
        ...
        let vote_pubkey = panoptes_sdk::pubkey::new_rand();
        let authorized_voter = Keypair::new();
    ...
    fn test_add_builtin_loader_no_overwrite() {
        ...
        let slot = 123;
        let loader_id = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_reconfigure_token2_native_mint() {
        ...
        let mut genesis_config =
            create_genesis_config_with_leader(5, &panoptes_sdk::pubkey::new_rand(), 0).genesis_config;
    ...
    fn test_ensure_no_storage_rewards_pool() {
        ...
        let reward_pubkey = panoptes_sdk::pubkey::new_rand();
        genesis_config.rewards_pools.insert(
            reward_pubkey,
            Account::new(u64::MAX, 0, &panoptes_sdk::pubkey::new_rand()),
        );
        let bank0 = Bank::new(&genesis_config);
    ...
    fn test_cached_executors() {
        ...
        let key2 = panoptes_sdk::pubkey::new_rand();
        let key3 = panoptes_sdk::pubkey::new_rand();
        let key4 = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bank_executor_cache() {
        ...
        // Check inheritance
        let bank = Bank::new_from_parent(&Arc::new(bank), &panoptes_sdk::pubkey::new_rand(), 1);
        let executors = bank.get_executors(&message, loaders);
        assert_eq!(executors.borrow().executors.len(), 4);
        assert!(executors.borrow().executors.contains_key(&key1));
        assert!(executors.borrow().executors.contains_key(&key2));
            ...
            ) + std::marker::Send,
    {
        ...
        let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(panoptes_sdk::pubkey::new_rand)
            .take(total_pubkeys)
            .collect();
    ...
    fn test_get_inflation_start_slot_devnet_testnet() {
        let GenesisConfigInfo {
            mut genesis_config, ..
        } = create_genesis_config_with_leader(42, &panoptes_sdk::pubkey::new_rand(), 42);
        genesis_config
            .accounts
    ...
    fn test_get_largest_accounts() {
        ...
        // Initialize accounts; all have larger PANO balances than current Bank built-ins
    ...
    fn test_transfer_sysvar() {
        ...
        fn mock_ix_processor(
            ...
            use panoptes_sdk::account::WritableAccount;
            let keyed_accounts = invoke_context.get_keyed_accounts()?;
