...
impl ::panoptes_frozen_abi::abi_example::AbiExample for MessageProcessor {
    fn example() -> Self {
...
mod tests {
    ...
    fn test_invoke_context() {
        ...
        for i in 0..MAX_DEPTH {
            invoke_stack.push(panoptes_sdk::pubkey::new_rand());
            keys.push(panoptes_sdk::pubkey::new_rand());
        ...
        for program_id in invoke_stack.iter() {
            accounts.push(Rc::new(RefCell::new(AccountSharedData::new(
                1,
                1,
                &panoptes_sdk::pubkey::Pubkey::default(),
            ))));
    ...
    fn test_verify_account_changes_owner() {
        ...
        let alice_program_id = panoptes_sdk::pubkey::new_rand();
        let mallory_program_id = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_verify_account_changes_executable() {
        let owner = panoptes_sdk::pubkey::new_rand();
        let mallory_program_id = panoptes_sdk::pubkey::new_rand();
        let system_program_id = system_program::id();
    ...
    fn test_verify_account_changes_deduct_lamports_and_reassign_account() {
        let alice_program_id = panoptes_sdk::pubkey::new_rand();
        let bob_program_id = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_process_cross_program() {
        ...
        let caller_program_id = panoptes_sdk::pubkey::new_rand();
        let callee_program_id = panoptes_sdk::pubkey::new_rand();
        ...
        let owned_key = panoptes_sdk::pubkey::new_rand();
        let owned_account = AccountSharedData::new(42, 1, &callee_program_id);

        let not_owned_key = panoptes_sdk::pubkey::new_rand();
        let not_owned_account = AccountSharedData::new(84, 1, &panoptes_sdk::pubkey::new_rand());
