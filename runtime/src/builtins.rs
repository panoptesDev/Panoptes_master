...
fn genesis_builtins() -> Vec<Builtin> {
    vec![
        ...
        Builtin::new(
            ...
            with_program_logging!(panoptes_vote_program::vote_instruction::process_instruction),
        ),
        Builtin::new(
            "stake_program",
            stake::program::id(),
            with_program_logging!(panoptes_stake_program::stake_instruction::process_instruction),
        ),
        Builtin::new(
            "config_program",
            panoptes_config_program::id(),
            with_program_logging!(panoptes_config_program::config_processor::process_instruction),
        ),
    ]
}
...
/// https://github.com/panoptes-labs/panoptes/blob/84b139cc94b5be7c9e0c18c2ad91743231b85a0d/runtime/src/bank.rs#L1723
fn feature_builtins() -> Vec<(Builtin, Pubkey, ActivationType)> {
    vec![(
        Builtin::new(
            "secp256k1_program",
            panoptes_sdk::secp256k1_program::id(),
            panoptes_secp256k1_program::process_instruction,
        ),
