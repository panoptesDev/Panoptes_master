...
impl Stakes {
    ...
    pub fn is_stake(account: &AccountSharedData) -> bool {
        panoptes_vote_program::check_id(account.owner())
    ...
    pub fn store(
        ...
        if panoptes_vote_program::check_id(account.owner()) {
...
pub mod tests {
    use super::*;
    use panoptes_sdk::{account::WritableAccount, pubkey::Pubkey, rent::Rent};
    use panoptes_stake_program::stake_state;
    use panoptes_vote_program::vote_state::{self, VoteState, VoteStateVersions};
    ...
    pub fn create_staked_node_accounts(
        ...
        let vote_account =
            vote_state::create_account(&vote_pubkey, &panoptes_sdk::pubkey::new_rand(), 0, 1);
        (
