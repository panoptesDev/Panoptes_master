...
use panoptes_frozen_abi::abi_example::IgnoreAsHelper;
use {super::*, panoptes_measure::measure::Measure, std::cell::RefCell};
...
#[cfg(all(test, RUSTC_WITH_SPECIALIZATION))]
impl panoptes_frozen_abi::abi_example::IgnoreAsHelper for SerializableAccountStorageEntry {}
