...
use panoptes_config_program::{create_config_account, get_config_data};
use panoptes_sdk::{
...
#[deprecated(
    since = "1.7.2",
    note = "Please use `panoptes_sdk::stake::config` or `panoptes_program::stake::config` instead"
)]
pub use panoptes_sdk::stake::config::*;
