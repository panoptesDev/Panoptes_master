...
impl VoteState {
    ...
    fn get_max_sized_vote_state() -> VoteState {
        ...
        for i in 0..=MAX_LEADER_SCHEDULE_EPOCH_OFFSET {
            authorized_voters.insert(i, panoptes_sdk::pubkey::new_rand());
        }
...
mod tests {
    ...
    impl VoteState {
        pub fn new_for_test(auth_pubkey: &Pubkey) -> Self {
            Self::new(
                &VoteInit {
                    node_pubkey: panoptes_sdk::pubkey::new_rand(),
    ...
    fn test_initialize_vote_account() {
        let vote_account_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        let node_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    {
        let vote_pubkey = panoptes_sdk::pubkey::new_rand();
        let authorized_voter = panoptes_sdk::pubkey::new_rand();
        let authorized_withdrawer = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_vote_signature() {
        ...
        let keyed_accounts = &[KeyedAccount::new(&vote_pubkey, false, &vote_account)];
        let signers: HashSet<Pubkey> = get_signers(keyed_accounts);
        let authorized_voter_pubkey = panoptes_sdk::pubkey::new_rand();
        let res = authorize(
            &keyed_accounts[0],
        ...
        let keyed_accounts = &[KeyedAccount::new(&vote_pubkey, true, &vote_account)];
        let signers: HashSet<Pubkey> = get_signers(keyed_accounts);
        let authorized_withdrawer_pubkey = panoptes_sdk::pubkey::new_rand();
        let res = authorize(
            &keyed_accounts[0],
    ...
    fn test_vote_double_lockout_after_expiration() {
        let voter_pubkey = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_process_missed_votes() {
        let account_a = panoptes_sdk::pubkey::new_rand();
        let mut vote_state_a = VoteState::new_for_test(&account_a);
        let account_b = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_vote_state_withdraw() {
        ...
        let res = withdraw(
            &keyed_accounts[0],
            lamports,
            &KeyedAccount::new(&panoptes_sdk::pubkey::new_rand(), false, &to_account),
            &signers,
        );
        assert_eq!(res, Ok(()));
    ...
    fn test_get_and_update_authorized_voter() {
        let original_voter = panoptes_sdk::pubkey::new_rand();
        ...
        let new_authorized_voter = panoptes_sdk::pubkey::new_rand();
        vote_state
    ...
    fn test_set_new_authorized_voter() {
        ...
        let new_voter = panoptes_sdk::pubkey::new_rand();
        ...
        let new_voter2 = panoptes_sdk::pubkey::new_rand();
        vote_state
        ...
        let new_voter3 = panoptes_sdk::pubkey::new_rand();
        vote_state
