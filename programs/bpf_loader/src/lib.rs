...
use panoptes_runtime::message_processor::MessageProcessor;
use panoptes_sdk::{
    ...
    match limited_deserialize(instruction_data)? {
        ...
        UpgradeableLoaderInstruction::DeployWithMaxDataLen { max_data_len } => {
            ...
            let signers = [&[program.unsigned_key().as_ref(), &[bump_seed]]]
                ...
                .collect::<Result<Vec<Pubkey>, panoptes_sdk::pubkey::PubkeyError>>()?;
...
// Well, implement Debug for panoptes_rbpf::vm::Executable in panoptes-rbpf...
...
mod tests {
    ...
    fn test_bpf_loader_non_terminating_program() {
        ...
        panoptes_rbpf::elf::register_bpf_function(&mut bpf_functions, 0, "entrypoint").unwrap();
    ...
    fn test_bpf_loader_write() {
        ...
        let program_key = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_bpf_loader_invoke_main() {
        ...
        let duplicate_key = panoptes_sdk::pubkey::new_rand();
        let parameter_account = AccountSharedData::new_ref(1, 0, &program_id);
