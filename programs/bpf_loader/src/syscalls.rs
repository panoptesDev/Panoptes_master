...
mod tests {
    ...
    fn test_translate_type() {
        ...
        let instruction = Instruction::new_with_bincode(
            ...
            &"foobar",
            vec![AccountMeta::new(panoptes_sdk::pubkey::new_rand(), false)],
        );
    ...
    fn test_translate_slice() {
        ...
        // Pubkeys
        let mut data = vec![panoptes_sdk::pubkey::new_rand(); 5];
        let addr = data.as_ptr() as *const _ as u64;
        let memory_mapping = MemoryMapping::new::<UserError>(
            vec![MemoryRegion {
                host_addr: addr,
        ...
        .unwrap();
        assert_eq!(data, translated_data);
        data[0] = panoptes_sdk::pubkey::new_rand(); // Both should point to same place
        assert_eq!(data, translated_data);
    }
