...
use panoptes_bpf_loader_program::serialization::{
...
use panoptes_sdk::{keyed_account::KeyedAccount, pubkey::Pubkey};
...
fn create_inputs() -> (
    ...
    let dup_key = panoptes_sdk::pubkey::new_rand();
    let dup_key2 = panoptes_sdk::pubkey::new_rand();
    let keys = vec![
        dup_key,
        dup_key,
