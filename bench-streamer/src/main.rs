...
use panoptes_streamer::packet::{Packet, Packets, PacketsRecycler, PACKET_DATA_SIZE};
use panoptes_streamer::streamer::{receiver, PacketReceiver};
use std::cmp::max;
...
fn main() -> Result<()> {
    ...
    for _ in 0..num_sockets {
        let read = panoptes_net_utils::bind_to(ip_addr, port, false).unwrap();
