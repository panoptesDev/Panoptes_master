...
pub enum LedgerError {
    #[error("Panoptes app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Panoptes message")]
    PanoptesInvalidMessage = 0x6a80,

    #[error("Panoptes summary finalization failed on Ledger device")]
    PanoptesSummaryFinalizeFailed = 0x6f00,

    #[error("Panoptes summary update failed on Ledger device")]
    PanoptesSummaryUpdateFailed = 0x6f01,
