...
VALIDATOR_KEYS_DIR=$PANOPTES_CONFIG_DIR/validator$label
...
if ((airdrops_enabled)); then
  ...
  $panoptes_cli \
    "${common_args[@]}" --keypair "$PANOPTES_CONFIG_DIR/faucet.json" \
