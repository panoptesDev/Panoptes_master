...
use rayon::prelude::*;
use panoptes_core::banking_stage::BankingStage;
use panoptes_gossip::{cluster_info::ClusterInfo, cluster_info::Node};
use panoptes_ledger::{
...
use panoptes_poh::poh_recorder::{create_test_recorder, PohRecorder, WorkingBankEntry};
...
fn make_accounts_txs(
    ...
    (0..total_num_transactions)
        ...
        .map(|_| {
            ...
            if !same_payer {
                new.message.account_keys[0] = panoptes_sdk::pubkey::new_rand();
            }
            new.message.account_keys[1] = panoptes_sdk::pubkey::new_rand();
