...
use panoptes_bench_tps::{
    bench::{do_bench_tps, generate_and_fund_keypairs},
    cli::Config,
};
use panoptes_client::thin_client::create_client;
use panoptes_core::validator::ValidatorConfig;
use panoptes_faucet::faucet::run_local_faucet_with_port;
use panoptes_gossip::cluster_info::VALIDATOR_PORT_RANGE;
...
#[test]
#[serial]
fn test_bench_tps_local_cluster_panoptes() {
