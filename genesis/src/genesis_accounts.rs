...
use panoptes_sdk::{genesis_config::GenesisConfig, native_token::LAMPORTS_PER_PANO};
...
pub const COMMUNITY_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 1 * LAMPORTS_PER_PANO + 41 * LAMPORTS_PER_PANO / 100,
...
pub fn add_genesis_accounts(genesis_config: &mut GenesisConfig, mut issued_lamports: u64) {
    ...
    // "one thanks" (community pool) gets 134_217_728PANO (total) - above distributions
    create_and_add_stakes(
        genesis_config,
        &StakerInfo {
            name: "one thanks",
            staker: "7vEAL3nS9CWmy1q6njUUyHE7Cf5RmyQpND6CsoHjzPiR",
            lamports: (134_217_728 * LAMPORTS_PER_PANO).saturating_sub(issued_lamports),
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        ...
        assert_eq!(134_217_728 * LAMPORTS_PER_PANO, lamports);
    }
}
