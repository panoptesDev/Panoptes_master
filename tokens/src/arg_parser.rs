...
use panoptes_cli_config::CONFIG_FILE;
use panoptes_remote_wallet::remote_wallet::maybe_wallet_manager;
use panoptes_sdk::native_token::sol_to_lamports;
    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("url")
                ...
                .takes_value(true)
                .value_name("URL")
                .help("RPC entrypoint address. i.e. http://api.devnet.panoptes.com"),
        )
        .subcommand(
            SubCommand::with_name("distribute-tokens")
                .about("Distribute PANO")
                .arg(
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in PANO"),
                )
                .arg(
            ...
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_sol")
                        ...
                        .long("unlocked-sol")
                        .takes_value(true)
                        .value_name("PANO_AMOUNT")
                        .help("Amount of PANO to put in system account to pay for fees"),
                )
                .arg(
