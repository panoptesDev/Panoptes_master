...
use panoptes_sdk::{instruction::Instruction, native_token::lamports_to_sol};
...
mod tests {
    ...
    // BanksClient into the `panoptes-tokens` methods. With the revert to RpcClient in this module
    // (https://github.com/panoptes-labs/panoptes/pull/13623), that approach was no longer viable.
    ...
    //
    // https://github.com/panoptes-labs/panoptes/blob/5511d52c6284013a24ced10966d11d8f4585799e/tokens/src/spl_token.rs#L490-L685
}
