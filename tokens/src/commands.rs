...
use panoptes_account_decoder::parse_token::{
...
use panoptes_transaction_status::TransactionStatus;
use spl_associated_token_account_v1_0::get_associated_token_address;
use spl_token_v2_0::panoptes_program::program_error::ProgramError;
use std::{
    cmp::{self},
    io,
    sync::{
...
use panoptes_sdk::{pubkey::Pubkey, signature::Keypair};
...
pub fn test_process_distribute_tokens_with_client(
    ...
    let alice_pubkey = panoptes_sdk::pubkey::new_rand();
...
mod tests {
    ...
    fn test_apply_previous_transactions() {
        let alice = panoptes_sdk::pubkey::new_rand();
        let bob = panoptes_sdk::pubkey::new_rand();
    ...
    fn test_set_split_stake_lockup() {
        ...
        let stake_account_address = panoptes_sdk::pubkey::new_rand();
        let new_stake_account_address = panoptes_sdk::pubkey::new_rand();
    ...
    fn initialize_check_payer_balances_inputs(
        ...
        let recipient = panoptes_sdk::pubkey::new_rand();
        let allocations = vec![Allocation {
    ...
    fn test_check_payer_balances_distribute_stakes_single_payer() {
        ...
        let expensive_allocations = vec![Allocation {
            recipient: panoptes_sdk::pubkey::new_rand().to_string(),
