...
use panoptes_core::serve_repair::RepairProtocol;
use panoptes_gossip::{contact_info::ContactInfo, gossip_service::discover};
...
fn run_dos(
    ...
    if !nodes.is_empty() {
        ...
        contact.id = panoptes_sdk::pubkey::new_rand();
