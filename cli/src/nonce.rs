...
use panoptes_cli_output::CliNonceAccount;
use panoptes_client::{nonce_utils::*, rpc_client::RpcClient};
...
mod tests {
    ...
    fn test_check_nonce_account() {
        ...
        let nonce_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        let data = Versions::new_current(State::Initialized(nonce::state::Data {
            authority: panoptes_sdk::pubkey::new_rand(),
            blockhash,
            fee_calculator: FeeCalculator::default(),
        }));
