...
use panoptes_transaction_status::UiTransactionEncoding;
...
pub fn process_catchup(
    ...
    loop {
        ...
        // especially if pointing to api.meinnet-beta.panoptes.com at times
...
pub fn process_show_stakes(
    ...
    let mut program_accounts_config = RpcProgramAccountsConfig {
        account_config: RpcAccountInfoConfig {
            encoding: Some(panoptes_account_decoder::UiAccountEncoding::Base64),
...
mod tests {
    ...
    use panoptes_sdk::signature::{write_keypair, Keypair};
    use std::str::FromStr;
