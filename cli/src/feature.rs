...
use panoptes_clap_utils::{input_parsers::*, input_validators::*, keypair::*};
use panoptes_cli_output::{QuietDisplay, VerboseDisplay};
use panoptes_client::{client_error::ClientError, rpc_client::RpcClient};
...
fn feature_activation_allowed(rpc_client: &RpcClient, quiet: bool) -> Result<bool, ClientError> {
    let my_feature_set = panoptes_version::Version::default().feature_set;
