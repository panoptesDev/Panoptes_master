...
use panoptes_faucet::faucet::run_local_faucet;
use panoptes_sdk::{
    account_utils::StateMut,
    commitment_config::CommitmentConfig,
    signature::{Keypair, Signer},
};
use panoptes_vote_program::vote_state::{VoteAuthorize, VoteState, VoteStateVersions};
...
fn test_vote_authorize_and_withdraw() {
    ...
    let destination_account = panoptes_sdk::pubkey::new_rand(); // Send withdrawal to new account to make balance check easy
