// This bench attempts to justify the value of `panoptes_core::poh_service::NUM_HASHES_PER_BATCH`
...
use {
    ...
    panoptes_poh::poh_service::DEFAULT_HASHES_PER_BATCH,
    panoptes_sdk::hash::Hash,
    std::sync::{
