...
use {
    ...
    log::*,
    panoptes_ledger::poh::Poh,
    panoptes_measure::measure::Measure,
    panoptes_sdk::poh_config::PohConfig,
    std::{
        sync::{
...
impl PohService {
    pub fn new(
        ...
        let tick_producer = Builder::new()
            .name("panoptes-poh-service-tick_producer".to_string())
            .spawn(move || {
                panoptes_sys_tuner::request_realtime_poh();
...
mod tests {
    use {
        ...
        panoptes_runtime::bank::Bank,
        panoptes_sdk::{clock, hash::hash, pubkey::Pubkey, timing},
        std::time::Duration,
    };
    ...
    fn test_poh_service() {
        ...
        let ledger_path = get_tmp_ledger_path!();
        {
            ...
            let entry_producer = {
                ...
                Builder::new()
                    .name("panoptes-poh-service-entry_producer".to_string())
                    .spawn(move || {
                        let now = Instant::now();
                        let mut total_us = 0;
