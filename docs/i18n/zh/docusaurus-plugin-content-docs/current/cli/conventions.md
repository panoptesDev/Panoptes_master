---
title: 使用 Panoptes CLI 命令
---

在运行 Panoptes CLI 命令之前，让我们先来熟悉一下所有的命令。 首先，Panoptes CLI 实际上是你可能会用到操作的命令集合。 您可以通过运行以下操作查看所有可能命令的列表：
...
例如，如果文件系统密钥对文件位置是 `/home/panoptes/my_wallet.json`，请输入来显示地址：
