---
title: Using Panoptes CLI
---

Before running any Panoptes CLI commands, let's go over some conventions that
you will see across all commands. First, the Panoptes CLI is actually a collection
...
```bash
panoptes-keygen pubkey <KEYPAIR>
```
...
`/home/panoptes/my_wallet.json`, to display the address, do:

```bash
panoptes-keygen pubkey /home/panoptes/my_wallet.json
```
