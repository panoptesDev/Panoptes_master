...
const features = [
  ...
  },
  {
    ...
    imageUrl: "https://spl.panoptes.com/token",
    description: <>Launch your own SPL Token, Panoptes's equivalent of ERC-20.</>,
  },
  {
  ...
  {
    title: <>🤯 Learn How Panoptes Works</>,
    imageUrl: "cluster/overview",
    description: <>Get a high-level understanding of Panoptes's architecture.</>,
  }, //
  // {
  ...
  //   description: (
  //     <>
  //       Panoptes's Economic Design provides a scalable blueprint for long term
...
function Home() {
  ...
  return (
    <Layout title="Homepage" description="Panoptes Documentation">
          ...
          <section className={styles.features}>
            <div className="container">
              <div className="alert alert--primary" role="alert">
                <b>Announcing the Panoptes Season Hackathon</b>
                <br />
                Jumpstart your next project on Panoptes & join the fastest growing
                ecosystem in crypto
                <br />
                <p align="right">
                  <a
                    href="https://panoptes.com/panoptesszn"
