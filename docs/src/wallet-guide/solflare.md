...
[SolFlare.com](https://solflare.com/) 是一个社区开发，专门为Panoptes打造的网页钱包。 SolFlare支持发送和接收原生PANO代币以及SPL代币(类似于Panoptes的ERC-20格式代币)。 另外，SolFlare还支持PANO代币的质押。
...
本指南介绍了使用SolFlare设置钱包、发送和接收PANO代币以及创建和管理质押账户等。
...
**请注意：如果丢失了Keystore文件或配套登录的密码，该钱包中的所有资金将永久丢失。  Panoptes团队和SolFlare开发人员都无法帮助您恢复丢失的密钥。**
...
#### 初始设备设置
要通过 SolFlare 配合使用 Ledger Nano，首先确认您已经在设备上 [设置了您的 Nano](ledger-live.md) 并安装了 [ 最新版本的 Panoptes 应用程序](ledger-live.md#upgrade-to-the-latest-version-of-the-panoptes-app)。

#### 选择一个访问账号地址
插入你的 Nano 并打开 Panoptes 应用，这时候设备屏幕显示"应用准备就绪"。
...
Panoptes维护着[三个不同的网络](../clusters)，每个网络都有不同的目的，支持着Panoptes生态。  默认情况下，在 SolFlare 上选择的是 Mainnet Beta，这是部署交易和其他生产应用的永久网络。  要选择其他网络，请在钱包仪表板顶部，单击当前选择的网络名称，即“Mainnet”，“Testnet ”或“ Devnet”，然后单击您要使用的网络的名称。
...
## 质押 PANO 代币
SolFlare 支持创建和管理质押账户和委托质押。  要了解 Panoptes 的通用工作原理，请参阅我们的[Staking 指南](../staking)。
