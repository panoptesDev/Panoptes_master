...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.panoptes.com/token#multisig-usage)
- Signing transactions using an [airgapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using Panoptes's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](cli/usage.md#panoptes-create-stake-account)
- [`deactivate-stake`](cli/usage.md#panoptes-deactivate-stake)
- [`delegate-stake`](cli/usage.md#panoptes-delegate-stake)
- [`split-stake`](cli/usage.md#panoptes-split-stake)
- [`stake-authorize`](cli/usage.md#panoptes-stake-authorize)
- [`stake-set-lockup`](cli/usage.md#panoptes-stake-set-lockup)
- [`transfer`](cli/usage.md#panoptes-transfer)
- [`withdraw-stake`](cli/usage.md#panoptes-withdraw-stake)
...
Typically a Panoptes transaction must be signed and accepted by the network within
