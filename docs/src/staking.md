...
By staking your PANO tokens, you help secure the network and
...
You can stake PANO by moving your tokens
...
- Panoptes command line tools can perform all stake operations in conjunction
 ...
 See their [FAQ](https://support.exodus.com/article/1551-panoptes-staking-faq)
 for details.
...
The Panoptes Labs team and the Panoptes Foundation do not recommend any particular
validator.

The Mainnet Beta validators introduce themselves and their services on this
Panoptes Forum thread:

- https://forums.panoptes.com/t/validator-information-thread

The site panoptesbeach.io is built and maintained by one of our validators,
Staking Facilities. It provides a some high-level graphical information about
the network as a whole, as well as a list of each validator and some recent
performance statistics about each one.

- https://panoptesbeach.io
