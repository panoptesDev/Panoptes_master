...
submitted to the cluster. The Panoptes runtime will execute a program to process
...
a [digital signature](#signature-format) of the given message. The Panoptes
...
construct a
[`SystemInstruction::CreateAccount`](https://github.com/panoptes-labs/panoptes/blob/6606590b8132e56dab9e60b3f7d20ba7412a736c/sdk/program/src/system_instruction.rs#L63)
instruction:
...
are handled differently in that they are built directly into the Panoptes runtime.
...
The [Panoptes Program Library's Token
program](https://github.com/panoptes-labs/panoptes-program-library/tree/master/token)
...
[Pack](https://github.com/panoptes-labs/panoptes/blob/master/sdk/program/src/program_pack.rs)
