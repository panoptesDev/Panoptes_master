...
mod tests {
    ...
    use panoptes_runtime::bank::Bank;
    use panoptes_sdk::clock::NUM_CONSECUTIVE_LEADER_SLOTS;
    use panoptes_sdk::epoch_schedule::{
    ...
    fn test_next_leader_slot() {
        ...
        assert_eq!(
            cache.next_leader_slot(
                &panoptes_sdk::pubkey::new_rand(), // not in leader_schedule
                0,
                &bank,
                None,
                std::u64::MAX
    ...
    fn test_schedule_for_unconfirmed_epoch() {
        ...
        let bank2 = Bank::new_from_parent(&bank, &panoptes_sdk::pubkey::new_rand(), 95);
