...
use panoptes_config_program::{get_config_data, ConfigKeys};
use panoptes_sdk::pubkey::Pubkey;
use panoptes_sdk::stake::config::{self as stake_config, Config as StakeConfig};
...
mod test {
    ...
    use serde_json::json;
    use panoptes_config_program::create_config_account;
    use panoptes_sdk::account::ReadableAccount;
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = panoptes_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Panoptes"}"#).unwrap(),
            }),
        );
